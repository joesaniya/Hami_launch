        ...
        [
          Padding(
                              ...
                              (
                                child: Text('Newly Listed',
                                  style: TextStyle(
                                    ...
                                    color: _tabbed=='1'?Colors.white:Colors.grey,
                                  ),
                                )
                              ),
                            ),
                              ...
                              (
                                child: Text('Currently Listed',
                                  style: TextStyle(
                                    ...
                                    fontSize: 16,
                                    fontWeight: FontWeight.w700,
                                    color: _tabbed=='2'?Colors.white:Colors.grey,
                                  ),
                                )
                              ),
                            ),
                              ...
                              (
                                ...
                                (
                                  ...
                                  style: TextStyle(
                                    ...
                                    fontSize: 16,
                                    fontWeight: FontWeight.w700,
                                    color: _tabbed=='3'?Colors.white:Colors.grey,
                                  ),
                                )
                              ),
                            ),
              ...
              (
                ...
                child: _tabbed=='1' ? NewlyListed():_tabbed=='2' ? CurrentlyListed():SponsoredTab(),
              )
        ],
      ),
    );
